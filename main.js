        ...
        if(count_i == 0) {
            ...
            for(l=0; l<filesData[count_i].length; l++) {
                if(filesData[count_i][l].status = "Modified") {
                    for(k=0; k<filesData[count_i-1].length; k++) {
                        if(filesData[count_i-1][k].filename == filesData[count_i][l].filename) {
                            filesData[count_i][l].code =
                                applyPatch(filesData[count_i-1][k].code, filesData[count_i][l].changes);
                        }
                    }
                }
            }
...
console.log(modifyData(filesData));